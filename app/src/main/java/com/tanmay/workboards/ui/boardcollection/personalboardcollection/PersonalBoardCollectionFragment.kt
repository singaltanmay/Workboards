...
import kotlinx.android.synthetic.main.fragment_board_collection.fragment_board_collection_title_text_view as collectionTitle
...
class PersonalBoardCollectionFragment : BoardCollectionFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel =
            ViewModelProvider(this).get(PersonalBoardCollectionViewModel::class.java)
    }
